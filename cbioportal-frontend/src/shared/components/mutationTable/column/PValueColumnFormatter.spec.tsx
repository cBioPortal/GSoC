...
import { pValueRenderFunction } from './PValueColumnFormatter';
import { mount, ReactWrapper } from 'enzyme';

describe('PValueColumnFormatter', () => {
    ...
    beforeAll(() => {
        component1 = mount(
            pValueRenderFunction(rowDataByProteinChange, [mutation1])
        );
        component2 = mount(
            pValueRenderFunction(rowDataByProteinChange, [mutation2])
        );
        component3 = mount(
            pValueRenderFunction(rowDataByProteinChange, [mutation3])
        );
    });
    ...
    it('renders p-value correctly', () => {
        testRenderedValues(component1, '3.692e-4', 'bold');
        testRenderedValues(component2, '2.326e-3', 'bold');
